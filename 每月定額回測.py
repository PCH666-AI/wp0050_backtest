...
stock = pd.read_csv(r'C:\Users\Public\stock\0050股市資料\0050歷史股價.csv', encoding='UTF-8', low_memory=False, index_col=False)
dividend = pd.read_csv(r'C:\Users\Public\stock\0050股市資料\0050歷史股利.csv', encoding='UTF-8', low_memory=False, index_col=False)
